...
class ClustersOnlinesModel extends Model
{
  protected $table = 'cluster_online';
  protected $primaryKey = 'uid';
  //protected $returnType     = 'array'; // array or object or custom class
  protected $allowedFields = array('uid','checktype','username','ip_address','clus','user_agent','last_activity','uri');
