...
<aside class="main-sidebar sidebar-dark-info elevation-4">
  <!-- Brand Logo -->
  <a href="<?=base_url('index.php')?>" class="brand-link navbar-info navbar-dark">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?=base_url()?>/dashboard" class="nav-link <?php if($uri_two=='cluster' and empty($uri_tree)): echo "active"; endif;?>">
