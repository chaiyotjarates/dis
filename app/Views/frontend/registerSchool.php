...
<div class="login-box" style="opacity: 0.94;">
  ...
  <div class="card card-outline card-success">
    ...
    <div class="card-body">
      ...
      <form action="<?=base_url('/save_registerSchool')?>" id="registerSchool" method="post">
        <?= csrf_field(); ?>
        ...
        <div class="input-group mb-3">
          <select name="user_sch" id="user_sch" class="form-control" required>
    ...
    $(document).ready(function(){
        ...
        $('#user_clus').change(function() {
            ...
            success: function(data) {
                ...
                $('#user_area').html(html);
                $('#ีuser_sch').html('<option value="">เลือกโรงเรียน</option>');
            }
            });
            return false;
        });
