    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <form action="<?=base_url(session()->get('role').'/updateProfile')?>" name="profile" id="profile" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-9">
                            ...
                            <?php }else{ ?>
                            <img class="profile-user-img img-fluid img-circle" src="<?=base_url('uploads/profile/no_image.jpg')?>" />
                            <?php } ?>
                        </div>
                        </div>
                        ...
                        <div class="form-group row">
                        <label for="user_idcard" class="col-sm-3 col-form-label">เลขประชาชน</label>
...
<script>
    $(document).ready(function(){
        ...
        $('#user_prov').change(function() {
            var code = $(this).val();
            $.ajax({
                url: "https://moral.obec.go.th/kuru/teacher/amphurSearch",
                type: "POST",
                dataType: "json",
                data: {
                "code": code
        ...
        $('#user_amp').change(function() {
            var code = $(this).val();
            $.ajax({
                url: "https://moral.obec.go.th/kuru/teacher/tumbonSearch",
                type: "POST",
                dataType: "json",
                data: {
                "code": code
