    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/updateprofile_cluster')?>" name="profile" id="profile" method="post" autocomplete="off"  enctype="multipart/form-data">
...
$(document).on('click', '#btn-submit', function(e) {
    ...
    .then((updateprofile_cluster) => {
      if(updateprofile_cluster){
        $('#profile').submit();
      }
    });
});
...
$(document).ready(function(){
        ...
        $('#user_clus').change(function() {
            ...
            //alert(code);
            $.ajax({
            url: "<?php echo base_url('/register/clusterSearch');?>",
            type: "POST",
            dataType: "json",
            data: {
                "code": code
            ...
            success: function(data) {
                ...
                html += '<option value=' + data[i].cluster_code + '>' + data[i].cluster_name + '</option>';
                }
