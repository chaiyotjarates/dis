    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/updateprofile_area')?>" name="profile" id="profile" method="post" autocomplete="off"  enctype="multipart/form-data">
...
$(document).on('click', '#btn-submit', function(e) {
    ...
    .then((updateprofile_area) => {
      if(updateprofile_area){
        $('#profile').submit();
      }
    });
});
