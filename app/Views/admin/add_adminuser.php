    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/save_adminuser')?>" name="save_adminuser" id="save_adminuser" method="post" autocomplete="off" enctype="multipart/form-data">
