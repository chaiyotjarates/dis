    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/save_year')?>" name="save_year" id="save_year" method="post" autocomplete="off" enctype="multipart/form-data">


            <div class="form-group row">
              <label for="user_fname" class="col-sm-3 col-form-label">ปีการศึกษา <cite class="req-text">*</cite></label>
              <div class="col-sm-9">
              <input  style="max-width:300px;" type="text" class="form-control" id="y_name" name="y_name"  required>
              </div>
            </div>
