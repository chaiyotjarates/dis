    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/save_superuser')?>" name="save_superuser" id="save_superuser" method="post" autocomplete="off" enctype="multipart/form-data">
