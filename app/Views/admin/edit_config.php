    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/update_config')?>" name="update_config" id="update_config" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select name="co_year" id="co_year" class="form-control" style="max-width:250px;" required>
                  ...
                  <option value="<?=$x['y_name']?>" <?php if($x['y_name'] == trim($config['co_year'])){ echo 'selected'; }?>><?=$x['y_name']?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
              <input  type="text" class="form-control" id="co_title" name="co_title" value="<?=$config['co_title']?>" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_date_start" name="co_date_start" value="<?=$config['co_date_start']?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_date_end" name="co_date_end" value="<?=$config['co_date_end']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_areascore_start" name="co_areascore_start" value="<?=$config['co_areascore_start']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_areascore_end" name="co_areascore_end" value="<?=$config['co_areascore_end']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_clusscore_start" name="co_clusscore_start" value="<?=$config['co_clusscore_start']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_clusscore_end" name="co_clusscore_end" value="<?=$config['co_clusscore_end']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_datenote_start" name="co_datenote_start" value="<?=$config['co_datenote_start']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_datenote_end" name="co_datenote_end" value="<?=$config['co_datenote_end']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_datescore_start" name="co_datescore_start" value="<?=$config['co_datescore_start']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_datescore_end" name="co_datescore_end" value="<?=$config['co_datescore_end']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" class="form-control float-right" id="co_datepublish" name="co_datepublish" value="<?=$config['co_datepublish']?>">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar"></i></span>
                    </div>
                  </div>
			      ...
			      <input value="<?=$config['co_id']?>" type="hidden" name="co_id" id="co_id">
            <div class="form-group row">
