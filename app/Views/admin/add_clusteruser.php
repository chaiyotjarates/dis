    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('index.php/admin/save_clusteruser')?>" name="save_clusteruser" id="save_clusteruser" method="post" autocomplete="off" enctype="multipart/form-data">
...
$(document).on('click', '#btn-submit', function(e) {
    ...
    .then((save_clusteruser) => {
      if(save_clusteruser){
        var x = chkDigitPid();
        if(x != false){
        $('#save_clusteruser').submit();
		}
      }
    });
});
